...
def makeblock_conv(in_chs, out_chs, atype, stride=1):
    ...
    layer = nn.Conv2d(in_channels=in_chs, out_channels=out_chs, kernel_size=5, stride=stride)
...
class BasicBlockConv(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, atype):
        ...
        self.conv = nn.Conv2d(
            in_channels=in_chs, out_channels=out_chs, kernel_size=5, stride=1, padding=2
        )
